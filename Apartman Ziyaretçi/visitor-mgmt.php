...
<head>
  ...
  <!-- AdminLTE Temalar. İhtiyacınız olan temayı seçin, tüm temaları indirmektense yüklemeyi tercih edin -->
...
<div class="wrapper">
  ...
  <!-- İçerik Kapsayıcı. Sayfa içeriği içerir -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Ziyaretçiler</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Tüm Ziyaretçi Girişlerinin Görüntülenmesi</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-hover table-striped">
                ...
                <tr>
                  ...
                  <td><a href="action-visitor.php?editid=<?php echo $row['ID'];?>" title="Detayları Görüntüle"><i class="fa fa-eye" style="color:green;"></i> Görüntüle</a></td>
