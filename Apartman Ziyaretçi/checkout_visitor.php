...
<div class="wrapper">
  ...
  <!-- İçerik Alanı. Sayfa içeriği içerir -->
  <div class="content-wrapper">
    <!-- İçerik Başlığı (Sayfa başlığı) -->
    <section class="content-header">
      <h1>
        Ziyaretçileri Çıkış Yap
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Ziyaretçi Girişlerini Görüntüle</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-hover table-striped">
                ...
                <tr>
                  ...
                  <td><a href="action-visitor.php?editid=<?php echo $row['ID'];?>" title="Tam Detayları Görüntüle"><i class="fa fa-sign-out" style="color:green;"></i> Güncelle</a></td>
...
<!-- AdminLTE dashboard demo (Sadece demo amaçlıdır) -->
